<svg xmlns="http://www.w3.org/2000/svg" 
  ...
  <defs>
    <linearGradient id="grad-half-{{ $score }}" x1="45.31" y1="84.49" x2="45.31" y2="259.03" gradientUnits="userSpaceOnUse">
  ...
  <path d="M92.75,3.32l18.06,55.6c.55,1.68,2.11,2.82,
        ...
        style="fill:url(#grad-half-{{ $score }}); stroke:#fde966; stroke-miterlimit:10;"/>
</svg>